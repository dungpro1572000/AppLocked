...
// AppLocker Typography - Comprehensive text styles for light/dark themes
val Typography = Typography(
    ...
    // Label styles - for buttons, tabs, and small text
...
// Custom AppLocker specific text styles
object AppLockerTextStyles {
    // App name and branding
    val AppBrandName = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Bold,
        fontSize = 28.sp,
        lineHeight = 36.sp,
    ...
    // Security related text (warnings, errors)
    val SecurityWarning = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.SemiBold,
        fontSize = 16.sp,
        lineHeight = 24.sp,
    ...
    // Password and PIN related text
    val PasswordHint = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Normal,
        fontSize = 12.sp,
        lineHeight = 16.sp,
